...
}, { collection: 'parseTestdb' }); // collection is necessary here to specify

module.exports = mongoose.model("baseModel", basicSchema); // if collection not specified as a parameter in the new schema object, 
